#!/usr/bin/python3
"""
This module starts a simple Flask web application with several routes.
"""
...
def number_odd_or_even(n):
    """
    Returns an HTML page displaying 'Number: n is even' or 'Number: n is odd' inside an H1 tag.
    
    Args:
        n (int): The integer to check for even or odd.
    
    Returns:
        str: Rendered HTML template showing whether the number n is even or odd.
    """
